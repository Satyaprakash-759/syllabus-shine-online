...
export default function CambridgeALevelPage() {
    const { t } = useLanguage();
    const { data: pageData } = usePageData('cambridge/a-level');
    return (
        <Layout>


            <MetaSEO 
                seo={pageData?.seo || { metaTitle: 'Cambridge A Level | Ivy Bridge Elite Online Tutoring', metaDescription: 'Elite 1-on-1 tutoring for Cambridge A Levels at Ivy Bridge. Achieve top grades for global university admissions.' }} 
                defaultTitle="Cambridge A Level | Ivy Bridge Tutoring" 
            />
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16 md:mb-24 flex flex-col items-center">
                        ...
                        <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-7xl font-black uppercase mb-4 leading-tight">
                            <span className="text-navy">Cambridge</span> <span className="text-[#5595D9]">A Level</span> <br />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 p-1 xs:p-4 md:p-8">
                        {[
                            ...
                            {
                                name: 'IT & English',
                                items: ['Information Technology (9626)', 'Design & Technology (9705)', 'English Language (9093)', 'English Literature (9695)']
                            }
                        ].map((group, i) => (
